  ...
  $(document).ready(function(){
	...
	$("#allChex").click(function(){
	    ...
	    $("#UpdateBtn").click(function(){
	        ...
	        if(confirm("이대로 발주 메일을 보내시겠습니까? 직접/간이영수증 구매의 경우 바로 리스트에 등록됩니다.")){
	...
	<div class="popForm">
       ...
       <c:forEach items="${data}" var="item">
            ...
            <div class="listArea">
                    	...
                    	<span>
                    		<a href="#" class="btn_line_gray" id="BoxApplyAll">일반업체 일괄 적용</a>
                    	</span>
											...
											<td><fmt:formatNumber value="${line.minestimatedPrice}" pattern="#,###" /></td>
                                           	...
                                           	<td>
                                           		<select name="issueType" id="issueType${No}" style="width:80px;">
                                           			<option value="B" selected>선택</option>
                                           			<option value="B">일반업체발주</option>
                                           			<option value="C">직접구매(카드)</option>
                                           			<option value="H">간이영수증</option>
                                           		</select>
                                           	</td>                       
