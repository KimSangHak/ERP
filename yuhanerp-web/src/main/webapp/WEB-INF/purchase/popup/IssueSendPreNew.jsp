            ...
            <div class="listArea">
                        ...
                        <div class="listBox">
                        	  <table>
                                        ...
                                        <input type="hidden" id="jobPurchaseId" name="jobPurchaseId" value="${line.id}">
                                        <input type="hidden" id="modelNo" name="modelNo" value="${line.modelNo}">
                                        <input type="hidden" id="stockId${No}" name="stockId" value=" ">
                                        <input type="hidden" id="requestId" name="requestId" value="aa">
