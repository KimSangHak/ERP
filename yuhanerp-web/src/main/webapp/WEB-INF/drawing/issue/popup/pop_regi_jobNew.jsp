...
<div id="container">
	...
	<div class="popForm">
        ...
        <div class="popCont">
            ...
            <div class="progress">
            	<p class="blue">출도 달성 률은 현재 진행중인 Order에 해당되는 도면 출도 완료까지 몇 % 달성되었는지 입력하면 됩니다.</br> 출도기간은  '일' 단위 양의 정수로만 입력해주세요.(ex. 3시간 -> 1일)</p>
                <p>
                	<span>출도 달성률</span>
                    <span><input type="number" id="achievementPercent" class="w100"> %</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    
                    <span>출도 기간</span>
                    <span><input type="number" id="achievementDay" class="w100"> 일</span>
                </p>
            </div>
			...
			function F_FileMultiUpload_Callback(res) {
			    ...
			    myGrid = $("#jqlist").jqGrid({
			        ...
			        colModel:[
			            ...
			            {name:'classification',width:(pageWidth * (10/100)), editable : true, defaultValue : '1', edittype : 'select', formatter : 'select', editoptions : {value : "신규제작:신규제작;추가제작:추가제작;재제작:재제작;수정:수정;구매:구매;재료구매:재료구매;도면교체:도면교체;재출도:재출도;A/S제작:A/S제작" } },
