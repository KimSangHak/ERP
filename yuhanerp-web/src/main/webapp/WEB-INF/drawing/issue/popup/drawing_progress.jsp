...
<div id="container">
	...
	<div class="popForm">
        ...
        <div class="popTitArea">
        	<h1>${item.orderFullNo } ${item.device }<br> 설계 진행율 설정
			</h1>
        </div>
        <!-- //팝업 타이틀 -->
                   	...
                   	<table>
                        ...
                        <tbody>
                        	<tr>
                        		<th>설계 진행율</th>
                        		<td>
									<input type="number" id="assambleProg" value="${item.designProgress}">
                        		</td>
                        	</tr>
                        </tbody>
                    </table>
	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
			...
			$("#SaveButton").click(function(e){
				...
				$.ajax({   
					   type: "POST"  
					  ,url: "/drawing/design_progset"
					  ,data: {
						  key:orderId,
						  progValue:progVal
						  }
					  ,success:function(data){
							alert( "설계 진행률 수정 처리 되었습니다." );
