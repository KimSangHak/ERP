	...
	<div class="popForm">
        ...
        <div class="popCont">
            ...
            <div class="popList">
				...
				<form id="submitForm" action="/daily_report/register_jobNew" method="POST">
                ...
                <div class="popBox">
                    <table>
                        ...
                        <tr>
                            <th>출고일</th>															
                            <td><input type="text" name="shippingDate" class="AutoDatePicker" value="<fmt:formatDate pattern = "yyyy-MM-dd" value="${data.shippingDate}" />"></td>
                            <th>영업담당</th>
                            <td>
