                        	...
                        	<table>
                                ...
                                <tbody>
                                	...
                                	<tr id="JobJig${item.id }" data-id="${item.id }">
                                        ...
                                        <td><input type="text" class="AutoDatePicker" name="programDate" value="<fmt:formatDate pattern = "yyyy-MM-dd" value = "${item.programDate}" />"></td>
                                        ...
                                        <td><a data-target="JobJig${item.id }" class="btn_line_gray ButtonActionForJobJig">확인</a></td>
                                    </tr>
                                	</c:forEach>
