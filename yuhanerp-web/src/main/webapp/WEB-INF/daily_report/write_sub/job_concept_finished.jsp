                        	...
                        	<table>
                                ...
                                <tbody>
                                	...
                                	<tr id="Concept${item.id }">
                                        ...
                                        <td><a href="javascript:PopWin('01_business02_pop13.html','600','600','no');" class="btn_line_gray ButtonActionForConcept" data-target="Concept${item.id }">확인</a>
