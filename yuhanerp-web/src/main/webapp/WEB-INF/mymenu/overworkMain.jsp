	...
	<layout:put block="mainbody">
                ...
                <div class="contArea">
                    ...
                    <form method="get">
                        ...
                        <div class="searchBtn"><a href="#" class="btn_blue SubmitButton">검색</a>&nbsp;<a href="javascript:PopWin('${path}/mymenu/overworkA/insertPop','700','1500','no');" class="btn_blue">연장근무 신청</a>&nbsp;<a href="javascript:PopWin('${path}/mymenu/overworkB/insertPop','700','1500','no');" class="btn_blue">휴일근무 신청</a></div>
                        	...
                        	<table>              	
                                ...
                                <tbody>
                                	...
                                	<c:forEach items="${data }" var="entry">
                                			...
                                			<tr>
                                    			<td>${entry.title}</td>
                                        		<td><a href="javascript:PopWin('/mymenu/overwork/detailPop/${entry.id}','700','1500','no');">${entry.usrName}</a></td>
                                        		<td>
                                        			<c:choose>
