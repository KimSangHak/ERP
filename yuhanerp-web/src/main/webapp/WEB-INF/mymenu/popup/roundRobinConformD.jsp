...
$(document).ready(function(){	
	 ...
	 $("#conformButton").click(function(){
	    	...
	    	var roundKind = $("#roundKind").val();
	    
		
	    	
	        if(confirm("승인 후 취소는 불가능합니다. 진행 하시겠습니까?")){
	        	document.form1.target="parent";
	        	document.form1.action = "/mymenu/roundRobin/conformDPop/do";
	 ...
	 $("#conformAllButton").click(function(){
	        ...
	        if(confirm("승인 후 취소는 불가능합니다. 진행 하시겠습니까?")){
	        	document.form1.target="parent";
	        	document.form1.action = "/mymenu/roundRobin/conformDPopAll/do";
	        	document.form1.submit();
	        	self.close();
	        }
	    });
            ...
            <div class="listBox">
                        	<table>              	
                        		...
                        		<div class="etcArea">
            					 ...
            					 <div class="etcArea">
                    				*구매 부서 지정 :     
                   					<select name="roundKind" id="roundKind" style="width:263px;">
                    					<option value="P" <c:if test="${line.roundKind eq 'P'}">selected</c:if>>구매부</option>
                    					<option value="M" <c:if test="${line.roundKind eq 'M'}">selected</c:if>>관리부</option>
                 				 	</select>     
            					</div>
