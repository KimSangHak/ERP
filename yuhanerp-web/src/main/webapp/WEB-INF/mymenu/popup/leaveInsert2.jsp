...
$(document).ready(function(){	
	  ...
	  $("#selectusr").change(function(){
		  
		  
		  var usr = this.value;
		  
		  $.ajax({
				url: "/mymenu/leave/dataUsr",
				data :  {
					usr : usr
				},
				dataType : "json",
            ...
            <div class="popList">
                ...
                <div class="popBox">
                    <table>
                        ...
                        <tr>
                        	<th>부서</th>
                            <td colspan="6"><input type="text" id="deptName" name="deptName" value=""></td>
                            
                        </tr>
                        <tr>
                        	<th>직위</th>
                            <td colspan="2"><input type="text" id="position" name="position" value=""></td>
                            <th colspan="2">성명*</th>
                            <td colspan="2">
                            
                           		<select name="selectusr" id="selectusr" style="width:263px;">
                ...
                <p>
                    ...
                    <span>신청자 : <input type="text" class="w100" value="전결" readonly></span>
