...
$(document).ready(function(){	
	  ...
	  $("#registerButton").click(function(){
	        ...
	        if(confirm("이대로 휴일근무를 신청하시겠습니까?")){
	        	document.form1.target="parent";
	        	document.form1.action = "/mymenu/overworkB/insert/do";
            ...
            <div class="popList">
                ...
                <div class="popBox">
                    <table>
                        ...
                        <tr>
                            <th rowspan="2" colspan="2" id="taCenter" style="font-size:20px; font-weight:700;">휴일 근무 신청서</th>
                            <th rowspan="2">결제</td>
                        ...
                        <tr>
                        	<th>시작 시간</br>*(24시간계 입력)</br>*두자리 입력(공란0)</br><b>*숫자만 입력</b></th>
                            <td colspan="6">
                            	<input type="text" id="strhour" name="strhour" style="width:130px;">
                            	&nbsp;:&nbsp;
                            	<input type="text" id="strmin" name="strmin" style="width:130px;">
                            	</br>
                            	<b style="color:red;">*ex) 아침 9시 8분 -> 09 : 08</b>
                            	</br>
                            	<b style="color:red;">*ex) 오후 1시 8분 -> 13 : 08</b>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td colspan="6">
                            	...
                            	<b style="color:red;">*ex) 아침 09시 8분 -> 09 : 08</b>
                            	</br>
                            	<b style="color:red;">*ex) 오후 7시 8분 -> 19 : 08</b>
                            </td>
                        </tr>
                ...
                <!-- //게시판 -->
                 ...
                 <div class="etcArea">
            	<p>위와 같이 휴일근무를 신청하오니 허락하여 주시기 바랍니다.</p>
                <p>
             ...
             <div class="popBtn">
                ...
                <a href="#" id="registerButton" class="btn_blue">휴일근무 신청</a>
             </div>
