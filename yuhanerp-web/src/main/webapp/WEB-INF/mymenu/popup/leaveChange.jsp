        ...
        <div class="popCont">
            ...
            <div class="popList">
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td colspan="6">
                            	...
                            	<textarea id="requestReason" name="requestReason" rows="5" placeholder="변경사유 상세 입력&#13;&#10;변경 전/후 기간 입력&#13;&#10;변경 신청 시 기존 휴가원 삭제 "></textarea>
                ...
                <!-- //게시판 -->
                 ...
                 <div class="etcArea">
            	<p>위와 같이 휴가원을 변경하오니 허락하여 주시기 바랍니다.</p>
                <p>
                    ...
                    <input type="hidden" id="changeY" name="changeY" value="Y">
             ...
             <div class="popBtn">
                ...
                <a href="#" id="registerButton" class="btn_blue">휴가원 변경 신청</a>
             </div>
