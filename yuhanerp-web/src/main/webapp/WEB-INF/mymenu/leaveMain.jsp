	...
	<layout:put block="mainbody">
                ...
                <div class="titArea">
                    <ul class="navi">
                        ...
                        <li>연월차</li>
                        <li>연월차 등록/조회</li>
                        <li style="color:red;"><b>나의 남은 연월차 일수: ${dateLeave} 일 ${hourLeave} 시간 (1일 8시간 기준)</b></li>
                ...
                <div class="contArea">
                    ...
                    <form method="get">
                        ...
                        <div class="searchBtn">
                        <c:if test="${isFM eq 'Y'}">
                        	<a href="javascript:PopWin('${path}/mymenu/leave/editUsrleavePop','700','1500','no');" class="btn_blue">직원 연차 조회/수정</a>
                        </c:if>
                        &nbsp;<a href="#" class="btn_blue SubmitButton">검색</a>&nbsp;
                        <a href="javascript:PopWin('${path}/mymenu/leave/insertPop','700','1500','no');" class="btn_blue">연월차 등록</a>
                        <c:if test="${isFM eq 'Y'}">
                        &nbsp;<a href="javascript:PopWin('${path}/mymenu/leave/insertPop2','700','1500','no');" class="btn_blue">대리 연월차 등록</a>
                        </c:if>
                        </div>
                        	...
                        	<table>              	
                                ...
                                <tbody>
                                	...
                                	<c:forEach items="${data }" var="entry">
                                			...
                                			<tr>
                                    			<td>${entry.title}</td>
                                        		<td><a href="javascript:PopWin('/mymenu/leave/detailPop/${entry.id}','700','1500','no');">${entry.usrName}</a></td>
