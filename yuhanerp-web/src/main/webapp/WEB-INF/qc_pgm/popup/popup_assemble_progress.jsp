...
<div id="container">
	...
	<div class="popForm">
        ...
        <div class="popTitArea">
        	<h1>${item.orderFullNo } ${item.device } 조립 진행율 설정
			</h1>
        </div>
        <!-- //팝업 타이틀 -->
                   	...
                   	<table>
                        ...
                        <tbody>
                        	<tr>
                        		<th>조립 진행율</th>
                        		<td>
									<input type="number" id="assambleProg" value="${item.assemblyProgress}">
                        		</td>
                        	</tr>
                        </tbody>
                    </table>
	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
			...
			$("#SaveButton").click(function(e){
				...
				$.ajax({   
					   type: "POST"  
					  ,url: "/qcPgm/assemble_progset"
					  ,data: {
						  key:orderId,
						  assambleProg:progVal
						  }
					  ,success:function(data){
							alert( "조립 진행률 수정 처리 되었습니다." );
