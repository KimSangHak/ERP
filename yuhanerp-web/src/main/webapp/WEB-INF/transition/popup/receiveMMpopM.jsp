	  ...
	  $("#delete").on("click", function() {
	        ...
	        if(chk > 0) {
	            ...
	            $("input[name='record']:checked").each(function() {
	            	...
	            	$(".id"+trid).remove();
	    			$(".jobDesignDrawingId"+trid).remove();
	    ...
	    $("#UpdateBtn").click(function(){
	    	...
	    	var id = $("#id").val();
	    	var jobDesignDrawingId = $("#jobDesignDrawingId").val();
	    	
	    
	    	
	        if(confirm("인수확인을 하겠습니까?")){
	        	document.form1.target="parent";
	        	document.form1.action = "/transition/mmReciveAct";
                        ...
                        <div class="listBox">
                        	  <table>
                                       ...
                                       <col style="width:5%;" />
                                        ...
                                        <tr id="${No}">
											...
											<td>${line.quantity}</td>
                                           	...
                                           	<td>
                    								...
                    								<option value="A" selected>일반인계</option>
                    								<option value="M">도면변경</option>
                    								<option value="P">재가공등록</option>
                                        ...
                                        <input type="hidden" id="jobDesignDrawingId" name="jobDesignDrawingId" class="jobDesignDrawingId${No}" value="${line.jobDesignDrawingId}">
