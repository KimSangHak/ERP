    ...
    <script type="text/javascript">
    	...
    	$("#EditBtn").click(function(){
        	...
        	if(confirm("해당 직원 정보를 수정하시겠습니까?")){
        		...
        		document.form1.action = "${path}/Admin/popup/userEditAction";
    	...
    	$("#outBtn").click(function(){
    		...
    		if(confirm("해당 직원을 퇴사처리 하시겠습니까?")){
        		...
        		document.form1.target="parent";
        		document.form1.action = "${path}/Admin/popup/deleteUser";
        		document.form1.submit();
        		self.close();
            ...
            <div class="popList">
                ...
                <div class="popBox">
                    <table>
                        ...
                        <tr>
                            <th>비밀번호<span class="ncBlue">*</span></th>
                            <td><input type="password" name="password" id="w120"></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <select name="isAdmin" id="w260">
                                    <option value="Y" <c:if test="${user.isAdmin == 'Y'}">selected</c:if>>Yes </option>
                                    <option value="N" <c:if test="${user.isAdmin == 'N'}">selected</c:if>>No</option>
                                </select>
                            </td>
                        </tr>
                         ...
                         <tr>
                            ...
                            <td>
                                <select name="isQc" id="w260">
                                    <option value="Y" <c:if test="${user.isQc == 'Y'}">selected</c:if>>Yes </option>
                                    <option value="N" <c:if test="${user.isQc == 'N'}">selected</c:if>>No</option>
                                </select>
                            </td>
                        </tr>
                         ...
                         <tr>
                            ...
                            <td>
                                <select name="isPgm" id="w260">
                                    <option value="Y" <c:if test="${user.isPgm == 'Y'}">selected</c:if>>Yes </option>
                                    <option value="N" <c:if test="${user.isPgm == 'N'}">selected</c:if>>No</option>
                                </select>
                            </td>
                        </tr>
                         ...
                         <tr>
                            ...
                            <td>
                                <select name="isRobot" id="w260">
                                    <option value="Y" <c:if test="${user.isRobot == 'Y'}">selected</c:if>>Yes </option>
                                    <option value="N" <c:if test="${user.isRobot == 'N'}">selected</c:if>>No</option>
                                </select>
                            </td>
                        </tr>
                         ...
                         <tr>
                            <th>권한 수정<span class="ncBlue"></span></th>
                            <td>
                            	<a href="javascript:PopWin('/Admin/popup/userAuthorityEdit/${user.id}','800','800','no');" class="btn_line_blue">권한 등록</a>
