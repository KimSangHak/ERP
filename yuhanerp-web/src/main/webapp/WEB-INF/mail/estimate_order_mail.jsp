...
<div id="container">
	...
	<div class="popForm">
        ...
        <div class="popCont">
            ...
            <form id="SendMailForm" action="/mail/send/outsourcing" method="POST">
            <!-- 회원찾기 -->
            <div class="client">
                <div class="client_search">
                	...
                	<ul>
                        ...
                        <li><span>담당자 메일</span>
                        	<em class="pl3">
							<c:choose>
								<c:when test="${recipient.personMail eq null}">
									<input type="text"	value="${recipient.corporateMail}"  name="partnerEmail" id="w320">
								</c:when>
								<c:otherwise>
									<input type="text"	value="${recipient.personMail}"  name="partnerEmail" id="w320">
								</c:otherwise>
							</c:choose>
                        	</em>
                        </li>
            ...
            <!-- //팝업 서브타이틀 -->
                ...
                <input type="hidden" name="sendPartnerId" value="${partnerId }"/>
		...
		$(document).ready(function(){
			...
			nhn.husky.EZCreator.createInIFrame({
                ...
                fOnAppLoad: function () {
                    ...
                    var targetUrl = "/mail/internal/outsourcing/" + type + "/" + id;
                    console.log("loading body from " + targetUrl + ", partnerId=" + partnerId);
