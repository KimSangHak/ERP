...
<div id="container">
            ...
            <div class="popList">
                ...
                <div class="popBoard">
                	...
                	<form id="Form" method="POST">
                		  ...
                		  <div id="outsourcingPartnerListHtml" style="witdth : 20px;">
								<select id="outPartnerId" name="outPartnerId">
									<option value="">-- 미지정 --</option>
									<c:forEach items="${seldata }" var="entry">
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td><input type="number" name="unitPrice" id="unitPrice" class="unitPrice" value="0"></td>
                            <td></td>
                            <td>
                            	<input type="text" name="drawingUrl" value="">
                            	<input type="hidden" name="jobDrawingId" value="${item.id }"/>
                            	<input type="hidden" name="jobDrawingOutUid" value="${item.outUid }"/>
                            	<input type="hidden" name="workPosition" value="${item.workPosition }"/>
                            </td>
                        </tr>
                        </c:forEach>
                    </table>
	...
	$(document).ready(function(){
		...
		$("#requestEstimation").click(function(e){
			...
			var out_partner_id = $("#outPartnerId").val();
			if(out_partner_id==null || $.trim(out_partner_id) == '') {
				alert("추가발주할 외주 업체를 선택하세요.");
				return;
			}
			...
			//var withPostprocessing = $("#outsourcingPartnerId").val();
			//alert(withPostprocessing);

			$("#Form").ajaxSubmit({
				url : "/ps/process/reoutsourcing",
